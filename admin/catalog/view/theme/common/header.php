  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo route('users/userProfile&id='.$_SESSION['user_id']); ?>" class="d-block">Admin</a>
          <a href="<?php echo route('users/logout'); ?>"> ออกจากระบบ</a>
        </div>
      </div>
      ...
      */ ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo route('advertising'); ?>" class="nav-link">
              <i class="nav-icon fas fa-ellipsis-h"></i>
              <p>AD โฆษณา</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo route('users'); ?>" class="nav-link">
              <i class="nav-icon fas fa-ellipsis-h"></i>
              <p>ผู้ใช้งาน</p>
            </a>
          </li>
